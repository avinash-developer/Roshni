...
//    private lateinit var mqttManager: AWSIotMqttManager;
    ...
    val light_control_button = findViewById<View>(R.id.light_control) as ImageButton
    val technical_support = findViewById<View>(R.id.technical_support) as ImageButton
    val openstore=findViewById<View>(R.id.store) as ImageButton

    light_control_button.setOnClickListener(View.OnClickListener {
        startActivity(Intent(this@MainActivity, LightControl::class.java))
        finish()
    })
    technical_support.setOnClickListener(View.OnClickListener {
        startActivity(Intent(this@MainActivity, Analytics::class.java))
        finish()
    })
